...
Спецификация функциональных требований была дополнена описанием функций карточек для запоминания новых слов.
...
![Обновленная диаграмма UML](https://github.com/EVTrukhina/practicum_Y/blob/main/Use%20Case%20Diagram%20UML.png)
<p align="center">Рис 2. Обновленная Use Case Diagram UML (видео)</p>

  // Или, если картинки нет:
  // Обновленная диаграмма UML: добавлены варианты использования 'Просмотреть видео', 'Управление субтитрами', 'Переключение скорости видео', 'Приостановка воспроизведения видео' к существующей диаграмме.  См. файл с диаграммой [ссылка на файл диаграммы].
