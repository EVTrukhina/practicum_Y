...
Спроектировать API для нового раздела «Страхование домашних животных» в приложении LUCKY, позволяющего пользователям просматривать описание страховок для котов и собак.
