...
|[Задача 2. Реализация API для новой функциональности](https://github.com/EVTrukhina/practicum_Y/edit/main/task_2.md)| Доработана C4-диаграмма. Разработан API (Job Stories, шаги, границы) и задокументирован в формате Swagger YAML.|`Модель C4`, `проектирование API`, `Job Stories`, `YAML`, `Swagger`|
