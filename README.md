...
|[Проект 5. Разработка API для сервиса Otium](https://github.com/EVTrukhina/practicum_Y/blob/main/project_4.md)| Сформулирована задача для backend-разработчика по доработке API.|`UML Sequence Diagram`, `REST API`, `JSON`, `Swagger`|
