...
|[Задача 4. Постановка задачи на бэкенд и фронтенд](https://github.com/EVTrukhina/practicum_Y/blob/main/task_4.md)|Проведено тестирование, составлено ПМИ, создано руководство пользователя.|`Ручное тестирование`,  `план тестирования`, `тест-кейс`, `ПМИ` |
