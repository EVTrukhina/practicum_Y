...
|[Задача 3. Программа и методика испытаний](https://github.com/EVTrukhina/practicum_Y/blob/main/task_3.md)|Проведение тестирования, составление ПМИ, создание руководства пользователя.|`Ручное тестирование`,  `план тестирования`, `тест-кейс`, `ПМИ` |
