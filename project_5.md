...
Разработана [User Story Map (USM)](https://miro.com/app/board/uXjVIciAY-8=/) для приложения умного дома, включающая User Stories, сформулированные в соответствии с принципами INVEST. На основе анализа интервью и персон выделен MVP. User Stories, вошедшие в MVP, дополнены критериями и сценариями приемки, написанными на языке Gherkin.
