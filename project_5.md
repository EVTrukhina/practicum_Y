...
|---|---|---|---|---|
| **Пользователь** | Данные пользователя, указанные при регистрации | Электронная почта + Имя пользователя + Пароль пользователя |  |  |
...
| **Дом** | Дом для управления | Код дома + Название дома + 1:10 {дом} + 1:10 {комнат} + 1:10 {сценариев} + 1:100 {устройств} |  |  |
