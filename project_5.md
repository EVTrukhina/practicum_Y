...
В рамках [ПМИ](https://docs.google.com/document/d/1t7uKfPOblkO9qgdKZ6iU3XrDv7519JWMLvQgvfZDKCk/edit?usp=sharing) мобильного приложения «Stets» версии 1.0 рассмотрены следующие основные функции:

1.  **Управление учетной записью:** Регистрация, Авторизация, Восстановление пароля, Изменение email, Выход.

2.  **Управление устройствами:** Добавление (QR-код/Вручную), Удаление.

3.  **Управление комнатами:** Добавление/Изменение/Удаление, Управление устройствами в комнате, Энергосбережение.

4.  **Управление сценариями:** Создание (авто/ручной запуск), Удаление, Запуск.

5.  **Управление доступом к дому:** Добавление пользователя, Принятие доступа.
