...
| **TR-4: Формирование устройств в доме** |  
| TR-4: Добавить устройство по QR-коду | Пользователь сканирует устройства фирмы «Stets» | 1. Нажать на кнопку «Добавить устройство по QR-коду» во вкладке устройства<br>2. Нажать на кнопку «Сканировать QR-код» при наведении | 1. Экран сканирования<br>2. Система автоматически отображает данные устройства в полях ввода: ID устройства, модель устройства и тип<br>3. Указать название устройства<br>4. Нажать на кнопку «Сохранить»<br>5. Устройство добавлено в списке устройств |
| TR-4.1: Добавить устройство по QR-коду. Альтернативный сценарий: обработка невалидных данных при сканировании | Пользователь сканирует устройства другой фирмы | 1. Нажать на кнопку «Добавить устройство по QR-коду» во вкладке устройства<br>2. Нажать на кнопку «Сканировать QR-код» при наведении | 1. Экран сканирования<br>2. Отобразилось уведомление об ошибке «Устройства других производителей не поддерживаются» |
| TR-4.2: Добавить устройство по QR-коду. Альтернативный сценарий: добавить устройство повторно | Пользователь ранее добавил устройство | 1. Нажать на кнопку «Добавить устройство по QR-коду» во вкладке устройства<br>2. Нажать на кнопку «Сканировать QR-код» при наведении | 1. Экран сканирования<br>2. Отобразилось уведомление об ошибке «Устройство уже добавлено» |
| TR-4.3: Добавить устройство по QR-коду. Альтернативный сценарий: ограничение устройств | Пользователь добавил 100 устройств | 1. Нажать на кнопку «Добавить устройство по QR-коду» во вкладке устройства<br>2. Нажать на кнопку «Сканировать QR-код» при наведении | 1. Экран сканирования<br>2. Отобразилось уведомление об ошибке «Достигнут лимит на количество устройств (100)»<br>3. Устройство не добавлено |
| TR-4.4: Добавить устройство вручную |  | 1. Нажать на кнопку «Добавить устройство вручную» во вкладке устройства<br>2. Ввести валидное значение в поле ID устройства<br>3. Ввести значение в поле модель устройства<br>4. Выбрать тип устройства «Светильник»<br>5. Указать название устройства<br>6. Нажать на кнопку «Сохранить» | 1. Экран добавления устройства<br>2. Значения в поле «ID устройства» введено валидное<br>3. Значения в поле «Модель устройства» введено валидное<br>4. Выбран тип устройства «Светильник»<br>5. Название устройства автоматически присваивает в соответствии его модели<br>6. Кнопка «Сохранить» становиться активной<br>7. Устройство успешно добавлено в списке устройств |
| TR-4.5: Удалить устройство | Пользователь должен добавить хотя бы одно устройство в доме | 1. Смахнуть выбранное устройства влево<br>2. Выбрать опцию «Удалить»<br>3. Подтвердить удаление, нажав кнопку «Удалить» | 1. Появляется опция «Удалить»<br>2. Открывается диалоговое окно подтверждения удаления<br>3. Устройство удалено из списка устройств<br>4. Отобразилось уведомление «Устройство успешно удалено» |
| **TR-5: Добавить комнату** | 
| TR-5: Добавить комнату |  | 1. Нажать на кнопку «Добавить комнату» во вкладке комната<br>2. Выбрать тип комнаты и иконку из предустановленного выбора<br>3. Нажать на кнопку «Сохранить» | 1. Экран с выбором типа комнаты и выбора иконки<br>2. Чекбокс тип комнаты включен и иконка выделена цветом<br>3. Кнопка «Сохранить» становиться активной<br>4. В списке комнат отображается карточка с названием типа комнаты<br>5. Отобразилось уведомление об успехе «Комната успешно добавлена» |
| TR-5.1: Изменить данные комнаты | Пользователь должен добавить хотя бы одну комнату | 1. Нажать на комнату из списка<br>2. На экране с информацией о комнате нажать на «Тип комнаты»<br>3. Выбрать новый тип комнаты и иконку из предустановленного выбора<br>4. Нажать на кнопку «Сохранить» | 1. Экран с информацией о комнате<br>2. Экран с выбором типа комнаты и выбора иконки<br>3. Чекбокс тип комнаты включен и иконка выделена цветом<br>4. Кнопка «Сохранить» становиться активной<br>5. В списке комнат отображается карточка с названием нового типа комнаты<br>6. Отобразилось уведомление об успехе «Комната успешно изменена» |
| TR-5.2: Удалить комнату | Пользователь должен добавить хотя бы одну комнату | 1. Нажать на комнату из списка<br>2. На экране с информацией о комнате нажать на кнопку «Удалить»<br>3. Подтвердить удаление, нажав кнопку «Удалить» | 1. Экран с информацией о комнате<br>2. Открывается диалоговое окно<br>3. Комната удалена из списка<br>4. Отобразилось уведомление об успехе «Комната успешно удалена» |
| TR-5.3: Добавление устройства в комнату | Пользователь должен иметь хотя бы одно добавленное устройство в комнате | 1. Нажать на комнату из списка<br>2. На экране с информацией о комнате нажать на кнопку «Добавить устройство»<br>3. Выбрать устройство для добавления к комнату<br>4. Нажать на кнопку «Сохранить» | 1. Экран с информацией о комнате<br>2. Экран со списком устройств<br>3. Чекбокс устройства включен<br>4. Кнопка «Сохранить» становиться активной<br>5. В комнате отображается добавленное устройство<br>6. Отобразилось уведомление «Устройства успешно добавлено в комнату» |
| TR-5.4: Удаление устройства из комнаты |  | 1. Нажать на комнату из списка<br>2. Смахнуть выбранное устройства влево<br>3. Выбрать опцию «Удалить»<br>4. Подтвердить удаление, нажав кнопку «Удалить» | 1. Экран с информацией о комнате<br>2. Появляется опция «Удалить»<br>3. Открывается диалоговое окно подтверждения удаления<br>4. Устройство удалено из комнаты<br>5. Отобразилось уведомление «Устройство успешно удалено» |
| TR-5.5: Управление всеми устройствами комнате сразу | Пользователь должен иметь хотя бы одно добавленное устройство в доме | 1. Нажать на комнату из списка<br>2. Выбрать опцию включить/выключить все устройства в комнате | 1. Экран с информацией о комнате<br>2. Состояние всех устройств в меняется на противоположное |
| TR-5.6: Добавить комнату. Альтернативный сценарий: ограничение комнат | Пользователь добавил 10 комнат | 1. Нажать на кнопку «Добавить комнату» | 1. Отобразилось уведомление об ошибке «Достигнут лимит на количество комнат (10)» |
| TR-5.7: Выбор энергосберегающего режима | Пользователь должен иметь хотя бы одно добавленное устройство в комнате | 1. Нажать на комнату из списка<br>2. Выбрать нужное устройство<br>3. Нажать на вкл/откл режим энергосбережения | 1. Экран с информацией о комнате<br>2. Список устройств<br>3. Состояние режима энергосбережения изменяется на противоположный |
