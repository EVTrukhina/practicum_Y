...
Разработана [User Story Map (USM)](https://miro.com/app/board/uXjVIciAY-8=/) приложения умного дома с использованием User Stories, где каждая User Story сформулирована в соответствии с принципами INVEST. Выделен минимально жизнеспособный продукт (MVP) на основе анализа интервью и заданных персон.
Все истории из MVP дополнены критериями и сценариями приёмки написанных с помощью языка Gherkin.
